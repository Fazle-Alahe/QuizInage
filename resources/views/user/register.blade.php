...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>Image Quiz Register</title>
    ...
    <body class="login">
        ...
        <div id="login-container">
            ...
            @endif
            <!-- Login Form -->
            <form action="{{route('store.registration')}}" method="POST" class="form-horizontal">
                @csrf
                ...
                <div class="clearfix">
                    <div class="btn-group btn-group-sm pull-right">
                        <button type="submit" class="btn btn-success"><i class="fa fa-arrow-right"></i> Register</button>
                    </div>
                </div>
            </form>
            <!-- END Login Form -->
