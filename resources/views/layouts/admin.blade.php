...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>Image Quiz Dashboard</title>
        ...
        <link rel="stylesheet" href="{{asset('uploads/assets')}}/css/themes.css">
        <!-- END Stylesheets -->
    ...
    <body>
        ...
        <div id="page-container">
            ...
            <header class="navbars navbar-inverse">
                ...
                <!-- Logo -->
                <a href="{{route("dashboard")}}"><img src="{{asset('uploads/assets')}}/img/template/logo.png" alt="logo"></a>
                ...
                <ul id="widgets" class="navbar-nav-custom pull-right">
                    ...
                    <li class="dropdown pull-right dropdown-user">
                        <a href="javascript:void(0)" class="dropdown-toggle" data-toggle="dropdown"><img src="{{asset('uploads/assets')}}/img/template/avatar.png" alt="avatar"> <b class="caret"></b></a>
                        <h4 class="text-white">{{Auth::user()->name}}</h4>
                        <ul class="dropdown-menu">
                            <!-- Just a button demostrating how loading of widgets could happen, check main.js- - uiDemo() -->
                            <li>
                                <a href="{{route('logout')}}"><i class="fa fa-lock"></i> Log out</a>
                            </li>
                        </ul>
                    </li>
                    <!-- END User Menu -->
                ...
                <aside id="page-sidebar" class="collapse navbar-collapse navbar-main-collapse">
                    ...
                    <nav id="primary-nav">
                        <ul>
                            ...
                            <li>
                                <a href="{{route("quiz.page")}}" class="active"><i class="fa fa-fire"></i>Create quiz</a>
                            </li>
                            <li>
                                <a href="{{route("quiz.participate")}}" class="active"><i class="fa fa-fire"></i>Quiz participation</a>
                            </li>
                        </ul>
                    </nav>
